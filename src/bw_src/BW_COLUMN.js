...
export default class BW_COLUMN extends Component {
    ...
    set (id,name,bw_tbl_id,columntype,sequence_no,tx_id,default_string_value,default_float_value,default_integer_value,default_tbl_value,lookup_tbl_id,lookup_column_id,is_enumerated,width,is_active,source,attr){
        this.id = id;
        this.name=name;
        ...
        this.lookup_column_id=lookup_column_id;
